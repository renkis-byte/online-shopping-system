...
Product* ProductBookParser::makeProduct()
{
    ...
    cout << isbn_ << endl;
    cout << author_ << endl;*/
    Product* myprod = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
    //cout << endl;
    //cout << myprod->prodName_ << endl;
    //cout << myprod->price_ << endl;
    //cout << myprod->qty_ << endl;
    //cout << myprod->isbn_ << endl;
    //cout << myprod->author_ << endl;
    return myprod;
...
{
    Product* myprod = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
    return myprod;
...
{
    Product* myprod = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
    return myprod;
